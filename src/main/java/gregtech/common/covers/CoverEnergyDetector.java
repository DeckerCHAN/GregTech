...
public class CoverEnergyDetector extends CoverBehavior implements CoverWithUI, ITickable, IControllable {
    ...
    public CoverEnergyDetector(ICoverable coverHolder, EnumFacing attachedSide, int tier, int mbPerTick) {
